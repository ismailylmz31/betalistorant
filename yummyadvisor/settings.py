...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['.herokuapp.com', 'betalistorant.great-site.net'])
 #env.list('ALLOWED_HOSTS', default=['127.0.0.1', 'localhost','betalistorant.great-site.net'])
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #sonradan eklendi heroku deployu için
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://betalistorant.great-site.net",
